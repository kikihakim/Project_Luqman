...
$sql_update="select * from buku_2001082041 where idbuku='$id'";
...
if(isset($btnSimpan)){
    ...
    //Update ke table buku_2001082041 //
    $sql="UPDATE buku_2001082041 set judulbuku='$judulbuku',kategori='$kategori',
        pengarang='$pengarang',penerbit='$penerbit',status='$status',tahun='$tahun'
    where `idbuku` = '$idbuku'";
    $hasil=mysqli_query($db,$sql);

    //jika berhasil diupdate ke buku_2001082041
    if($hasil){
    //--Direct Url ke index pada folder buku-//
        echo "<script>location='?r=buku';</script>";
    } else{
        //Jika gagal di update ke buku_2001082041//
