...
if(isset($btnSimpan)){
    ...
    //Insert ke table buku_2001082041 //
    $sql="insert into buku_2001082041 value ('$idbuku','$judulbuku','$kategori','$pengarang',
        '$penerbit','$status','$tahun')";
    $hasil=mysqli_query($db,$sql);

    //jika berhasil diinsert ke buku_2001082041
    if($hasil){
    //--Direct Url ke index pada folder buku-//
        echo "<script>location='?r=buku';</script>";
    } else{
        //Jika gagal di insert ke buku_2001082041//
