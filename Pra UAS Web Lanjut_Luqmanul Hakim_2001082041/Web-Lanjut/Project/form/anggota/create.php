...
if (isset($btnSimpan)) {
    ...
    if (!empty($file_foto)) {
        ...
        //jika file foto tidak di upload //
        $sql="insert into tbanggota value ('$idanggota','$nama','$jeniskelamin',
                                            '$alamat','$tahun','')";
        $hasil= mysqli_query($db, $sql);
        if ($hasil) {
...
<form class="row g-3 needs-validation" enctype="multipart/form-data" action="index.php?r=fanggotacreate" method="POST" novalidate>
